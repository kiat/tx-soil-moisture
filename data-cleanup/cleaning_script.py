...
def main():
    ...
    station_ids = (
        range(1, 7) if args.station.lower() == "all" else [int(args.station)]
    )
...
def process_station(station_id, output_filename=None, cleaned_filename=None, missing_timestamps_filename=None):
    ...
    output_filename = output_filename or f"{output_dir}/Station{station_id}_missing_data.csv"
    cleaned_filename = cleaned_filename or f"{output_dir}/Station{station_id}_cleaned_data.csv"
    missing_timestamps_filename = missing_timestamps_filename or f"{output_dir}/Station{station_id}_missing_timestamps.csv"
