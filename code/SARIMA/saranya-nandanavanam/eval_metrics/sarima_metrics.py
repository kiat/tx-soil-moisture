...
# =================================================================
    #  Calculating ONLY RMSE and MAE
    # =================================================================
    mse = float(np.mean((actuals - preds) ** 2))   # Runs in background to find RMSE
    
    rmse = float(np.sqrt(mse))                     # Root Mean Squared Error
    mae = float(np.mean(np.abs(actuals - preds)))  # Mean Absolute Error
