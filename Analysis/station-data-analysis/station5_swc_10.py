...
# Prepare data for SWC_10 prediction
scaler = MinMaxScaler()
...
ar_importance = custom_ar_importance(scaled_data, features, 0)  # 0 is the index of SWC_10 in the target list
...
if all(importance is not None for importance in [rnn_importance_mse, cnn_importance_mse, ar_importance]):
    ...
    print("\nComparison of Feature Importance Across Models for SWC_10 Prediction (Normalized and Adjusted):")
...
with open('station5_swc_10_results.csv', 'w', newline='') as csvfile:
