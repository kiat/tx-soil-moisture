...
print("\nComparison of Feature Importance Across Models for SWC_5 Prediction (Normalized):")
...
with open('station5_swc_5_results.csv', 'w', newline='') as csvfile:
...
print("Results saved to station5_swc_5_results.csv")