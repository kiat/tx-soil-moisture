...
data = pd.read_csv('/Users/ayaannazir/Desktop/Research/tx-soil-moisture/datasets/Revised_Final_Data/station5_Revised_Final_Data.csv', index_col=0, parse_dates=True)
...
features = ['Ppt', 'T_50', 'Tair', 'RH', 'Windspeed', 'Winddirection', 'Srad']
target = ['SWC_50']
...
ar_importance_mse, ar_importance_mae, ar_importance_mae_percentage, ar_importance_r2 = custom_ar_importance(scaled_data, features, 0)  # 0 is the index of SWC_50 in the target list

# Print Custom AR results
print("\nCustom AR Results for SWC_50:")
for feature in features:
    print(f"{feature}:")
...
def display_feature_importance(importance_dict, model_name, metric_name):
    ...
    print(f"\n{model_name} Feature Importance for SWC_50 ({metric_name}):")
...
print("\nComparison of Feature Importance Across Models for SWC_50 Prediction (Normalized):")
...
with open('station5_SWC_50_results.csv', 'w', newline='') as csvfile:
...
print("Results saved to station5_SWC_50_results.csv")