...
# Prepare data for SWC_50 prediction
scaler = MinMaxScaler()
...
ar_importance = custom_ar_importance(scaled_data, features, 0)  # 0 is the index of SWC_50 in the target list
...
if all(importance is not None for importance in [rnn_importance_mse, cnn_importance_mse, ar_importance]):
    ...
    print("\nComparison of Feature Importance Across Models for SWC_50 Prediction (Normalized and Adjusted):")
