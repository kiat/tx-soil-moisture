...
ar_importance_mse, ar_importance_mae, ar_importance_mae_percentage, ar_importance_r2 = custom_ar_importance(scaled_data, features, 0)  # 0 is the index of SWC_20 in the target list

# Print Custom AR results
print("\nCustom AR Results for SWC_20:")
for feature in features:
    print(f"{feature}:")
...
print("\nComparison of Feature Importance Across Models for SWC_20 Prediction (Normalized):")
...
with open('station5_SWC_20_results.csv', 'w', newline='') as csvfile:
...
print("Results saved to station5_SWC_20_results.csv")