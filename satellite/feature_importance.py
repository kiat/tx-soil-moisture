...
def main():
    ...
    parser.add_argument("--features", type=str, required=True, help="The feature to predict (e.g., 'Sat_SM_SMAP')")
    ...
    for station, df in dfs.items():
        ...
        for config in configurations:
            ...
            # Simplified feature selection - only drop the other satellite feature
